...
class User(Base):
    ...
    two_fa_auth: Mapped[int]
    email_verified: Mapped[int] #= mapped_column(default=False, server_default=text('0'))
    phone_verified: Mapped[int] = mapped_column(default=False, server_default=text('0'))
    user_status: Mapped[int] #= mapped_column(Integer, nullable=False)
